...
from app.api.v1.system.config_view import SystemConfigView
from app.api.v1.system.dict_view import DictTypeView, DictDataView
...
# 系统配置
router.register("configs", SystemConfigView, basename="configs")
# 字典类型
router.register("dict-types", DictTypeView, basename="dict-types")
# 字典数据
